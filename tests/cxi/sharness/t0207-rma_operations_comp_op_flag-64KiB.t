...
test_expect_success "Test CXI RMA operations with threads" "
	insmod ${KFAB_DIR}/tests/cxi/single_client/test-rma-ops-thread.ko xfer_size=65536 rma_timeout=2 max_thread_cnt=1 max_loop_cnt=1 selective_comp=1 comp_op_flag=1 &&
